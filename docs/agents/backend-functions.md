...
Use the Datadog Apps agent skill when the task is about choosing between DDSQL and Action Catalog, configuring Connections, triggering Workflow Automation, or troubleshooting backend execution failures.
